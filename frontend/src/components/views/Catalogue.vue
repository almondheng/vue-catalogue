<template>
  <div class="container">
    ...
    <!-- Modal -->
    <product ref="product" :selected="selected" @save="onSave" />
    <popup ref="popup" title="Are you sure?" message="This action will delete" :selected="selected" @confirm ="onDelete" />
        ...
        <tbody>
          <tr v-for="(product, index) in products" :key="product.id">
            ...
            <td>
              ...
              <svg role="button" @click="getSelected(product)" data-bs-toggle="modal" data-bs-target="#popupModal" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
